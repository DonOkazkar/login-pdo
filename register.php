...
<head>
        ...
        <link rel="icon" type="image/jpg" sizes="16x16" href="admin/images/favicon.jpg">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong><?php echo($dd['sitename']) ?></h1>
                        </div>
                    </div>
                    <div class="row">
						...
						<?php if (!empty($_GET['error'])): ?>
								...
								<form role="form" action="register_post.php" method="post" class="registration-form">
